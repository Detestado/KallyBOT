...
module.exports.run = async (client, message, args) =>{
   ...
   const info = new Discord.RichEmbed()
      ...
      .addField(':inbox_tray: Entrou nesse servidor em:', dateFormat(member.joinedAt, 'dd/mm/yyyy'))
    ...
    .addField(':inbox_tray: Entrou nesse servidor em:', dateFormat(message.author.joinedAt, 'dd/mm/yyyy'))
