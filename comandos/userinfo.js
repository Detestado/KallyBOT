...
module.exports.run = async (client, message, args) =>{
   ...
   const info = new Discord.RichEmbed()
      ...
      .addField(':inbox_tray: Entrou nesse servido em:', dateFormat(member.joinedAt, 'mm/dd/yyyy'))
      .addField(':inbox_tray: Conta criado em:', dateFormat(member.user.createdAt, 'mm/dd/yyyy'))
      .setColor("#00a4ce")
      .setFooter("© Kally")
    ...
    .addField(':inbox_tray: Entrou nesse servido em:', dateFormat(message.author.joinedAt, 'mm/dd/yyyy'))
    .addField(':inbox_tray: Conta criado em:', dateFormat(message.author.createdAt, 'mm/dd/yyyy'))
    .setColor("#00a4ce")
    .setFooter("© Kally")
